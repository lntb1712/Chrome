...
namespace Chrome.Services.InventoryService
{
    public interface IInventoryService
    {
        ...
        Task<ServiceResponse<bool>> AddInventory(InventoryRequestDTO inventoryRequestDTO);
        Task<ServiceResponse<bool>> DeleteInventoryAsync(string warehouseCode, string locationCode, string productCode, string lotNo);
        Task<ServiceResponse<bool>> UpdateInventoryAsync(InventoryRequestDTO inventoryRequestDTO);
    }
}
